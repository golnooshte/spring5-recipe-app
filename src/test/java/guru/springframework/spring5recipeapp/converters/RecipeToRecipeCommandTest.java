...
public class RecipeToRecipeCommandTest {
    ...
    public void convert() throws Exception {
        ...
        recipe.setPreparation(PREP_TIME);
        recipe.setDescription(DESCRIPTION);
        recipe.setDifficulty(DIFFICULTY);
        recipe.setDirection(DIRECTIONS);
        recipe.setServingTime(SERVINGS);
        ...
        assertEquals(PREP_TIME, command.getPreparation());
        assertEquals(DESCRIPTION, command.getDescription());
        assertEquals(DIFFICULTY, command.getDifficulty());
        assertEquals(DIRECTIONS, command.getDirection());
        assertEquals(SERVINGS, command.getServingTime());
