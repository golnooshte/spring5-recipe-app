...
import guru.springframework.spring5recipeapp.convertor.*;
...
public class RecipeCommandToRecipeTest {
    ...
    public void setUp() throws Exception {
        converter = new RecipeCommandToRecipe(new CategoryCommandToCategory(),
                new IngredientCommandToIngredient(new UniteofMeasureCommmandtoMeeasure()),
    ...
    public void convert() throws Exception {
        ...
        recipeCommand.setPreparation(PREP_TIME);
        recipeCommand.setDescription(DESCRIPTION);
        recipeCommand.setDifficulty(DIFFICULTY);
        recipeCommand.setDirection(DIRECTIONS);
        recipeCommand.setServingTime(SERVINGS);
        ...
        assertEquals(PREP_TIME, recipe.getPreparation());
        assertEquals(DESCRIPTION, recipe.getDescription());
        assertEquals(DIFFICULTY, recipe.getDifficulty());
        assertEquals(DIRECTIONS, recipe.getDirection());
        assertEquals(SERVINGS, recipe.getServingTime());
